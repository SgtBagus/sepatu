              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <a href="<?= base_url('fitur/ekspor/konfig') ?>" target="_blank">
                    <button type="button" class="btn btn-sm btn-warning"><i class="fa fa-file-excel-o"></i> Ekspor Konfig</button> 
                  </a>
                  <button type="button" class="btn btn-sm btn-info" onclick="$('#modal-impor').modal()"><i class="fa fa-file-excel-o"></i> Import Konfig</button>
                  </div>
                </div>  
              </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Impor Konfig</h4>
        </div>
  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            var table = '<table class="table table-bordered" id="mytable">'+
                   '     <thead>'+
                   '     <tr>'+
                   '       <th style="width:20px">No</th>'+'<th>Slug</th>'+'<th>Value</th>'+'       <th style="width:150px">Status</th>'+
