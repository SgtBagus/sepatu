...
<div id="container">
    ...
    <div id="body">
        ...
        <p>
            See the article
            <a href="https://www.cloudways.com/blog/rest-api-in-codeigniter/" target="_blank">
        ...
        <p>
            Documentation
            <a href="<?= base_url('documentation') ?>" target="_blank">
                <?= base_url('documentation') ?>
            </a>
        </p>

        <div style="padding: 10px;background: #f0f0f0;">
            <h4>DEFAULT REST API</h4>
            <p>
                Click on the links to check whether the REST server is working. ( Ganti file ./application/config/rest.php dengan rest.php.sample )
            </p>
