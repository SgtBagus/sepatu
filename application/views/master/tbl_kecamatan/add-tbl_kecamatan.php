<form method="POST" action="<?= base_url('master/Tbl_kecamatan/store') ?>" id="upload-create" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" name="kabkot_id">
            ...
            foreach ($tbl_kabkot as $key => $value) {
                ?>
                <option value="<?= $value['id'] ?>"><?= $value['kabupaten_kota'] ?></option>
            <?php } ?>
        </select>
    </div>
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="form-kecamatan" placeholder="Masukan Kecamatan" name="dt[kecamatan]">
