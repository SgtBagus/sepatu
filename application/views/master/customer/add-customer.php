          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="form-nama_customer" placeholder="Masukan Nama Customer" name="dt[nama_customer]">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="dt[id_kelurahan]" id="kelurahan" style="width: 100%;">
                  <option value="">-Mohon Pilih Kecamatan Terlebih Dahulu-</option>
                </select>
              </div>
              <div class="form-group">
                <label>Kode Pos</label>
                <input type="text" class="form-control" name="dt[kode_post]" id="kodepost">
              </div>
              <div class="form-group">
                <label for="form-alamat_customer">Alamat Customer</label>
                <textarea name="dt[alamat_customer]" class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label for="form-email_customer">Email Customer</label>
                <input type="text" class="form-control" id="form-email_customer" placeholder="Masukan Email Customer" name="dt[email_customer]">
              </div>
              <div class="form-group">
                ...
                <select class="form-control select2" name="dt[id_sumtrafik]">
                  ...
                  foreach ($master_sumtrafik as $key => $value) {
                    ?>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="form-hp_customer" placeholder="Masukan Hp Customer" name="dt[hp_customer]">
              </div>
            </div>
            <div class="show_error"></div>
