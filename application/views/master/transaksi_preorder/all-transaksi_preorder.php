  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
                   ...
                   '       <th style="width:20px">No</th>'+'<th>Kode Transaksi</th>'+'<th>Id Produk Preorder</th>'+'<th>Qty</th>'+'<th>Ukuran</th>'+'<th>Warna</th>'+'<th>Keterangan</th>'+'<th>Harga Satuan</th>'+'<th>Biaya Lain</th>'+'<th>Diskon</th>'+'<th>Harga Total</th>'+'       <th style="width:150px">Status</th>'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                ajax: {"url": "<?= base_url('master/Transaksi_preorder/json?status=') ?>"+status, "type": "POST"},

                columns: [

                    {"data": "id","orderable": false},{"data": "kode_transaksi"},{"data": "id_produk_preorder"},{"data": "qty"},{"data": "ukuran"},{"data": "warna"},{"data": "keterangan"},{"data": "harga_satuan"},{"data": "biaya_lain"},{"data": "diskon"},{"data": "harga_total"},
