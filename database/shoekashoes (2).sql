...
--
-- Host: 127.0.0.1
-- Generation Time: 30 Okt 2019 pada 00.16
-- Versi Server: 5.6.26
-- PHP Version: 5.6.12
...
(3, '6950c16c9bcc6995f376b297f163175943007.png', 'image/png', 'webfile/6950c16c9bcc6995f376b297f163175943007.png', 'user', 21, NULL, NULL, '2019-10-01 15:30:30'),
...
(38, '', '', '', 'produk_ready', 1, 'ENABLE', '2019-10-28 16:30:38', NULL),
(39, '', '', '', 'produk_ready', 2, 'ENABLE', '2019-10-28 16:31:01', NULL),
(40, '', '', '', 'produk_ready', 3, 'ENABLE', '2019-10-28 16:31:08', NULL),
...
CREATE TABLE IF NOT EXISTS `master_bahanbaku` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `master_kategori_suplier` (
  `id` int(11) NOT NULL,
  `nama_kategori` varchar(255) NOT NULL,
  `ket_kategori` text NOT NULL,
  `status` enum('ENABLE','DISABLE') NOT NULL,
...
(27, 'Manajemen Produk', 'fa fa-list', '#', '1', '0', '', 'ENABLE', '2019-08-16 10:55:53', '2019-09-27 15:32:28'),
...
(43, 'Transaksi Ready', 'fa fa-credit-card', 'master/transaksi_ready', '3', '0', '', 'ENABLE', '2019-10-22 12:21:32', '2019-10-22 12:31:33'),
(44, 'Transaks Preorder', 'fa fa-cart-plus', 'master/transaksi_preorder', '4', '0', '', 'ENABLE', '2019-10-22 12:31:25', NULL),
(45, 'Ready Stok', 'fa fa-shopping-cart', '#', '1', '0', NULL, 'ENABLE', NULL, NULL),
(46, 'Proses', 'fa fa-circle', '#', '1', '45', NULL, 'ENABLE', NULL, NULL),
(47, 'Selesai', 'fa fa-circle', '#', '1', '45', NULL, 'ENABLE', NULL, NULL),
(48, 'Pre Order', 'fa fa-shopping-cart', '#', '2', '0', NULL, 'ENABLE', NULL, NULL),
...
(52, 'Suplier', 'fa fa-share-square', '#', '3', '0', NULL, 'ENABLE', NULL, NULL),
...
(55, 'Pelanggan', 'fa fa-users', 'master/customer', '4', '0', '', 'ENABLE', NULL, '2019-10-28 17:37:56'),
(56, 'Laporan', 'fa fa-file', '#', '5', '0', NULL, 'ENABLE', NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `produk_preorder` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `produk_ready` (
  `id` int(11) NOT NULL,
  `id_suplier` int(11) NOT NULL,
  `id_kategori` int(11) NOT NULL,
  `id_bahanbaku` int(11) NOT NULL,
...
(1, 1, 3, 2, 'malini sneakers', 'malini sneakers', '5', '5', 'Maroon', '-', '300000', '475000', 'ENABLE', '2019-10-28 16:30:38', '0000-00-00 00:00:00', 19),
(2, 1, 3, 2, 'malini sneakers', 'malini sneakers', '5', '5', 'Merah', '-', '300000', '475000', 'ENABLE', '2019-10-28 16:31:01', '0000-00-00 00:00:00', 19),
(3, 1, 3, 2, 'malini sneakers', 'malini sneakers', '5', '5', 'Biru', '-', '300000', '475000', 'ENABLE', '2019-10-28 16:31:08', '0000-00-00 00:00:00', 19);
...
(17, 'Super Admin', 'ENABLE', '["17","27","16","34","28","36","35","37","29","38"]', '2018-10-12 17:03:59', '2019-10-03 14:33:07'),
...
--
-- Struktur dari tabel `transaksi_preorder`
--

CREATE TABLE IF NOT EXISTS `transaksi_preorder` (
  `id` int(11) NOT NULL,
  `kode_transaksi` varchar(255) NOT NULL,
...
(19, 'arvin', 'Arvin', 'arvin.fairuz.af@gmail.com', '89f6432af2e2bcea9489ad02cd27a134', 18, 'Sarinah Malang Ground Floor, Jl. Jenderal Basuki Rahmat No.2A', 1, 'ENABLE', '2019-08-16 00:00:00', '2019-10-01 16:16:18'),
...
--
-- Indexes for table `transaksi_preorder`
--
ALTER TABLE `transaksi_preorder`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `transaksi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `transaksi_preorder`
--
ALTER TABLE `transaksi_preorder`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
