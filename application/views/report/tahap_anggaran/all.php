        ...
        <div class="col-md-12">
          <div class="panel panel-success">
            <div class="panel-heading">
              ...
              <div class="row">
                <div class="col-md-12">
                <a class="btn btn-success pull-right btn-flat" href="<?= base_url('report/Tahap_anggaran/getExcel/') ?>" target="_blank"><i class="fa fa-file-excel-o"></i> Export Excel</a>
                </div>
              </div>
              <!-- FILTER  -->
            </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#idTable').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo base_url('report/Tahap_anggaran/ajaxall/')?>",
          "type": "POST"
        },
