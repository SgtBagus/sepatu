...
class Produk_preorder extends MY_Controller
{
...

	{
		...
		$this->datatables->select('produk_preorder.id,suplier.nama_suplier as id_suplier,master_kategori_produk.nama_kategori as id_kategori,master_bahanbaku.nama_bahanbaku as id_bahanbaku,produk_preorder.kode_barang,produk_preorder.nama_produk,produk_preorder.ket_produk,produk_preorder.harga_produksi,produk_preorder.harga_jual,user.name as created_by,produk_preorder.status');

		$this->datatables->where('produk_preorder.status', $status);

		$this->datatables->from('produk_preorder');
		$this->datatables->join('user', 'produk_preorder.created_by = user.id', 'left');
		$this->datatables->join('suplier', 'produk_preorder.id_suplier = suplier.id', 'left');
		$this->datatables->join('master_kategori_produk', 'produk_preorder.id_kategori = master_kategori_produk.id', 'left');
		$this->datatables->join('master_bahanbaku', 'produk_preorder.id_bahanbaku = master_bahanbaku.id', 'left');
...

	{
		...
		$data['produk_preorder'] = $this->mymodel->selectDataone('produk_preorder', array('id' => $id));
		$data['file'] = $this->mymodel->selectDataone('file', array('table_id' => $id, 'table' => 'produk_preorder'));
		$data['page_name'] = "produk_preorder";
...

	{
		...
		$this->mymodel->deleteData('produk_preorder',  array('id' => $id));
